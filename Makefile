...
par-shell: commandlinereader.o processManager.o main.o 
	$(CC) -o par-shell main.o commandlinereader.o processManager.o -lpthread -lm
...
main.o: main.c commandlinereader.h defines.h processManager.h
	$(CC) -g -c main.c

#regra para compilar ./processManager.o
processManager.o: processManager.c processManager.h
	$(CC) -g -c processManager.c
